...
export default function Navbar() {
  ...
  return (
    <motion.nav 
      ...
      className=" border-b border-white/10 w-full sticky top-0 z-50"
    >
      <div className="max-w-6xl mx-auto px-6 h-20 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8">
          <ul className="flex items-center gap-6 text-sm font-medium text-slate-300">
            <li>
               <Link href="https://upta.edu.ve/" className="hover: text-white transition-colors">
                Portal UPTA
              </Link>
              <Link href="/dashboard" className="hover:text-white transition-colors">Inicio</Link></li>
